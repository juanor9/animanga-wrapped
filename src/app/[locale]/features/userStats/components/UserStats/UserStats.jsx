    ...
    <section>
      ...
      {(anime && anime.length > 0) || (manga && manga.length > 0) ? (
        <>
          ...
          <p>
            💻 PC: Click &quot;Save&quot;, new tab opens, right-click, &quot;Save image as...&quot;.
          </p>
          <p>
        ...
        <p>
          <b>
            You didn&apos;t register any list for us. Please create your user again and check at
            least one list to analyze.
          </b>
        </p>
      )}
      {anime && anime.length > 0 ? <AnimeStatsDisplay lists={lists} /> : null}
