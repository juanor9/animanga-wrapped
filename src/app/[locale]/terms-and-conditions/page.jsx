...
const TermsAndConditionsPage = ({ params: { locale } }) => {
  ...
  return (
    <main>
      ...
      <h2>PREAMBLE</h2>
      <p>
        This Agreement (hereinafter referred to as &ldquo;the Agreement&ldquo;) outlines the terms
        and conditions governing the use of the software application named &ldquo;Your Anime and
        Manga Year Wrapped&ldquo; (hereinafter referred to as &ldquo;the Application&ldquo;),
        designed, developed, maintained, and licensed by Tanuki SAS, a business entity incorporated
        under the laws of the Republic of Colombia, identified with NIT number 901182452-4
        (hereinafter referred to as &ldquo;the Licensor&ldquo; or &ldquo;the Company&ldquo;).
      </p>
      ...
      <p>
        ...
        offered by the Application, acknowledges, agrees, and binds themselves to the stipulations
        set forth herein.
      </p>
      ...
      <p>
        2.2. The Licensor reserves an inalienable right, at its sole discretion, to introduce
        updates, enhancements, modifications, or changes to the Application, whether for the
        rectification of operational discrepancies, the annual augmentation of code, or the infusion
        of novel features.
      </p>
      <p>
        2.3. Any substantive or significant alterations, modifications, or changes to the
        Application&apos;s core functionalities will be duly communicated to Licensees via
        electronic mail.
      </p>
      ...
      <p>
        ...
        good conduct. Any usage for illicit, unauthorized, or prohibited purposes, or in
        contravention of the stipulations of this Agreement, shall be deemed a breach hereof.
      </p>
      ...
      <p>
        ...
        attention to security, confidentiality, and integrity, leveraging state-of-the-art
        protective measures, including but not limited to those offered by MongoDB and encryption
        methodologies like crypto and bcrypt.
      </p>
      <p>
        5.2. With the express and informed consent of the Licensee, the Licensor retains the
        unequivocal right to monetize, trade, or sell such data to vetted third-party entities.
        These third-party entities are strictly circumscribed to contact Licensees a singular time
        for every acquisition of data and are proscribed from disseminating this data outside their
        organizational confines.
      </p>
      <h2>6. Digital Footprints and Cookies</h2>
      <p>
        6.1. The Application, in its operational design, utilizes digital cookies to record and
      ...
      <p>
        7.1. To enhance performance and reduce redundant data storage, the Application has
        implemented a differentiated storage system for user-uploaded images. When a user generates
        content, such as a statistical summary image (&ldquo;Story Card&ldquo;), this content is
        uploaded to our secure cloud storage provider (Cloudinary).
      </p>
      <p>
        7.2. Upload Classification: All image uploads are categorized by a mandatory
        &apos;type&apos; field to determine the handling logic:
      </p>
      <ul>
        <li>
          <strong>Type &apos;media&apos;:</strong> This category is reserved for shared,
          non-personal assets, such as cover images for anime or manga series. Before uploading, the
          system checks if an identical asset (by name) already exists in our global media folder
      ...
      <p>
        7.3. All uploaded images are accessible only via a secure URL (HTTPS) provided by the
        service upon a successful upload.
      </p>
      <h2>8. Intellectual Property and Copyright Concerns</h2>
      <p>
        8.1. The Licensor retains full, exclusive, and unalienable rights over the source code,
        design paradigms, architectural schemas, and other proprietary elements of the Application.
      </p>
      <p>
        8.2. Any graphical representations, images, or references of individual manga or anime are
        the sole intellectual properties of their respective copyright holders and are employed
        herein strictly for referential purposes.
      </p>
      <p>
        8.3. Content Generated by the User: The Licensee retains full ownership rights to the
        content they generate using the Application, such as the downloadable &apos;Story
        Cards&apos;. By generating and uploading this content, the Licensee grants the Licensor a
        ...
        connection with the service provided by the Application and for promoting the service.
      </p>
      <p>
      ...
      <p>
        9.1. The Licensor does not furnish any warranty or guarantee regarding the
        Application&apos;s uninterrupted availability or operational consistency.
      </p>
      <p>
      ...
      <p>
        ...
        conventions. The authoritative reference for these conditions is the AniList API
      ...
      <p>
        The Application unambiguously demarcates its unofficial affiliation with AniList or
        AniChart, ensuring compliance with AniList&apos;s naming directives.
      </p>
      <p>10.4. Adult Content Disclaimer:</p>
      <p>
        Licensees are notified that the Application, while relying on AniList&apos;s isAdult
        boolean, does not guarantee the accurate categorization of content. Licensees are thus
        advised to exert discretion and prudence.
      </p>
      <p>
        10.5. Licensees curious about the commercial nuances of the AniList API are directed to
        engage in direct correspondence with AniList representatives at the furnished contact
        details.
      </p>
      ...
      <p>
        11.2. Any disputes, contentions, disagreements, or litigations arising from or related to
        the Application, the Licensor, or this Agreement shall be adjudicated exclusively by the
        competent courts of the Republic of Colombia.
      </p>
    </main>
  );
};
