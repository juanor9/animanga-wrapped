const TermsAndConditionsPage = () => (
  <section>
    ...
    <h3>7. Intellectual Property and Copyright Concerns</h3>
    <p>7.1. The Licensor retains full, exclusive, and unalienable rights over the source code,
      design paradigms, architectural schemas, and other proprietary elements of the Application.
    </p>
    <p>7.2. Any graphical representations, images, or references of individual manga or anime are
    ...
    <p>7.3. Licensees are permitted to share self-generated content on personal digital platforms.
    ...
    <h3>8. Limitation of Liability, Indemnification, and Warranties</h3>
    <p>8.1. The Licensor does not furnish any warranty or guarantee regarding the Application&apos;s
      uninterrupted availability or operational consistency.
    </p>
    <p>8.2. The Application is provisioned to the Licensee on an &ldquo;as
      is&ldquo; and &ldquo;as available&ldquo; basis,
      devoid of any implied or express warranties.
    </p>
    <p>8.3. Licensees hereby agree to indemnify and hold harmless the Licensor from any damages,
      liabilities, or legal ramifications arising from misuse or unauthorized utilization
      of the Application.
    </p>
    <h3>9. Compliance with AniList API Terms</h3>
    <p>9.1. The Application&apos;s operational mechanics are intertwined with the AniList API.
    ...
    <p>9.3. Adult Content Disclaimer:</p>
    ...
    <p>9.4. Licensees curious about the commercial nuances of the AniList API are directed to
      engage in direct correspondence with AniList representatives at the furnished
      contact details.
    </p>
    <h3>10. Governing Law and Jurisdiction</h3>
    <p>10.1. This Agreement, in its entirety, is governed by and construed in accordance
      with the substantive and procedural laws of the Republic of Colombia.
    </p>
    <p>10.2. Any disputes, contentions, disagreements, or litigations arising from or
