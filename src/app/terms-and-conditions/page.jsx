const TermsAndConditionsPage = () => (
  <main>
    ...
    <p>This Agreement (hereinafter referred to as &ldquo;the Agreement&ldquo;)
      ...
      (hereinafter referred to as &ldquo;the Application&ldquo;), designed, developed,
      maintained, and licensed by Tanuki SAS, a business entity incorporated
    ...
    <p>1.2. The Licensee, by accessing, browsing, and/or availing themselves of
    ...
    <p>2.2. The Licensor reserves an inalienable right, at its sole discretion, to
      introduce updates, enhancements, modifications, or changes to the Application,
      whether for the rectification of operational discrepancies, the annual augmentation
      of code, or the infusion of novel features.
    </p>
    <p>2.3. Any substantive or significant alterations, modifications, or changes to the
    ...
    <p>4.2. The Licensor, in its capacity as the data controller, will process, handle, manage,
    ...
    <p>5.1. Personal and usage data entrusted to the Licensor shall be safeguarded with
      ...
      by MongoDB and encryption methodologies like crypto and bcrypt.
    </p>
    <p>5.2. With the express and informed consent of the Licensee, the Licensor retains
      the unequivocal right to monetize, trade, or sell such data to vetted third-party entities.
      These third-party entities are strictly circumscribed to contact Licensees a singular
    ...
    <ul>
      <li><strong>Type &apos;media&apos;:</strong> This category is reserved for shared, non-personal assets, such as cover images for anime or manga series. Before uploading, the system checks if an identical asset (by name) already exists in our global media folder (&apos;animanga-wrapped/media_assets/&apos;). If a duplicate is found, the existing asset&apos;s URL is returned, preventing re-upload and conserving resources.</li>
    ...
    <p>8.2. Any graphical representations, images, or references of individual manga or anime are
    ...
    <p>8.3. Content Generated by the User: The Licensee retains full ownership rights to the content they generate using the Application, such as the downloadable &apos;Story Cards&apos;. By generating and uploading this content, the Licensee grants the Licensor a worldwide, non-exclusive, royalty-free, sublicensable, and transferable license to use, reproduce, distribute, prepare derivative works of, display, and perform the content in connection with the service provided by the Application and for promoting the service.</p>
    <p>8.4. Licensees are permitted to share self-generated content on personal digital platforms.
      Notwithstanding, the intellectual property rights of these creations remain
    ...
    <p>9.2. The Application is provisioned to the Licensee on an &ldquo;as
      is&ldquo; and &ldquo;as available&ldquo; basis,
      devoid of any implied or express warranties.
    </p>
    <p>9.3. Licensees hereby agree to indemnify and hold harmless the Licensor from any damages,
    ...
    <p>10.2. To ensure full compliance with AniList&apos;s terms of service, the Application explicitly does not store, cache, or otherwise retain any raw data fetched from the AniList API. The only data stored by the Application are the user&apos;s registration details (as outlined in the Privacy Policy) and the user-generated statistical images (&apos;stats&apos; type), which are considered derivative works and not a direct copy of AniList data.</p>
    <p>10.3. Naming Guidelines:</p>
    <p>The Application unambiguously demarcates its unofficial affiliation with AniList or
      AniChart, ensuring compliance with AniList&apos;s naming directives.
    </p>
    <p>10.4. Adult Content Disclaimer:</p>
    <p>Licensees are notified that the Application, while relying on AniList&apos;s isAdult boolean,
      does not guarantee the accurate categorization of content. Licensees are thus advised to
      exert discretion and prudence.
    </p>
    <p>10.5. Licensees curious about the commercial nuances of the AniList API are directed to
    ...
    <p>11.2. Any disputes, contentions, disagreements, or litigations arising from or
